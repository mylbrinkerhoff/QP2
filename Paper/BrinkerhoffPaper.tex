...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.6\textwidth]{../Gestures.png}
	\label{fig:GlottalGestures}
	\caption{Representation taken from \citet{dicanioCoarticulationToneGlottal2012}.}
\end{figure}

In investigating the viability of the LCH, this paper will investigate this in Santiago Laxopa Zapotec, a language with both contrastive tone and phonation. 
%------------------------------------
