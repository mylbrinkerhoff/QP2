...
\begin{itemize}
	...
	\item Table \ref{tab:laryngeal} shows the variable pronunciation of laryngealized vowels in Yalálag Zapotec, taken from \citet{avelinobecerraTopicsYalalagZapotec2004,avelinoAcousticElectroglottographicAnalyses2010}. 
	\end{itemize}
...
\begin{itemize}
	\item In order to explain and define this vowels, I will be taking acoustic measurements. 
				\begin{itemize}
